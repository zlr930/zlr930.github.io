...
export const internships = [
  {
    ...
    period: '2026.08 — 至今',
    points: [
      { label: '投标项目协同', detail: '负责投标项目的协同推进与进度跟踪，协同销售组、方案组、招采组完成招标文件拆解、任务分工、标书撰写以及组内评审，推动各环节按节点完成，目前已协同推进 5 个招投标项目。' },
      { label: '标讯商机挖掘', detail: '独立搭建投标商机搜寻 Agent 助手和网站平台，结合目标行业、项目类型、区域等筛选规则，常态化抓取公开网站新增商机信息，并对项目匹配度、业务相关性及初步可行性进行筛选，提升商机搜集与前期判断效率。' },
      { label: '客户开发与需求洞察', detail: '每周随销售人员开展客户陌访及商机线索跟进，与潜在客户建立联系及合作意向，了解客户现有物流模式、业务痛点及合作需求，协助匹配相应物流解决方案，为后续商机转化及销售跟进提供支持。' },
    ] satisfies DetailPoint[],
  },
  {
