...
const internshipCards = [
  ...
  },
  {
    ...
    logoClass: 'zjgsu',
    points: [
      { label: '高效执行', detail: '协助辅导员处理档案归档、报告整理、材料汇总及财务报销等事务；曾在短时间内完成 200 余份毕业档案整理，在高任务量下仍能保证信息核对准确、工作推进有序。' },
      { label: '细致落实', detail: '负责学生、老师及学院相关部门的事务对接，耐心解答问题、细致核对材料，及时协调处理信息偏差与材料遗漏，保障事务顺利推进。' },
    ],
  },
]
